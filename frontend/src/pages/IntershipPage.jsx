...
const InternshipPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Internships | TechAdvise</title>
        <meta name="description" content="Browse internship opportunities at TechAdvise and kickstart your career." />
        <meta property="og:title" content="Internships | TechAdvise" />
        <meta property="og:description" content="Browse internship opportunities at TechAdvise and kickstart your career." />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Internships | TechAdvise" />
        <meta name="twitter:description" content="Browse internship opportunities at TechAdvise and kickstart your career." />
      </Helmet>
