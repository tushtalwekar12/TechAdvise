...
const TermsOfServicePage = () => {
  return (
    <>
      <Helmet>
        <title>Terms of Service | TechAdvise</title>
        <meta name="description" content="Read the terms of service for using TechAdvise's website and services." />
        <meta property="og:title" content="Terms of Service | TechAdvise" />
        <meta property="og:description" content="Read the terms of service for using TechAdvise's website and services." />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Terms of Service | TechAdvise" />
        <meta name="twitter:description" content="Read the terms of service for using TechAdvise's website and services." />
      </Helmet>
