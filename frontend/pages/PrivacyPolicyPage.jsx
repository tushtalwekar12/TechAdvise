...
const PrivacyPolicyPage = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy | TechAdvise</title>
        <meta name="description" content="Read TechAdvise's privacy policy to understand how we handle your data." />
        <meta property="og:title" content="Privacy Policy | TechAdvise" />
        <meta property="og:description" content="Read TechAdvise's privacy policy to understand how we handle your data." />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Privacy Policy | TechAdvise" />
        <meta name="twitter:description" content="Read TechAdvise's privacy policy to understand how we handle your data." />
      </Helmet>
